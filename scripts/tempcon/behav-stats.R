#' ---
#' title: Plot Tempcon behavioral data
...
#' # Load data
# this file is created by `behav-load.R`
...
#' ## Quesiton source memory by item recognition
...
#' ## List source memory by item recognition
...
#' ### Do same half hits differ from chance?
t.test(itemrec_samediff_tt$same_half_hit, mu = 0.5)
