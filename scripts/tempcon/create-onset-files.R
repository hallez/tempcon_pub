...
for(isubj in subjects){
  ...
  cur_regressors <-
    ...
    dplyr::mutate(itemHit_model = ifelse(exclude_trial_exceeds_trs == "exclude", 99,
                  ...
                  itemHitBYType_model = ifelse(item_recog_scored == "rhitNT", 1,
                  ...
                  itemHitBYType_key = stringr::str_replace_all(item_recog_scored, "null", "excludeTrial"),
                  collapsedFhitMissFA_model = ifelse(item_recog_scored == "rhitNT", 1,
                                          ifelse(item_recog_scored == "rhitT", 1,
                                                 ifelse(item_recog_scored == "fhit", 2,
