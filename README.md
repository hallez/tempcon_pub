...
2. Identify outlier betas: `RSA_detect_outlier_betas.m`
  * NB: this is currently something I am working on integrating with my R scripts, but the beta outlier detection procedure I use here probably won't change. 
